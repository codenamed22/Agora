        ...
        >
          ...
          <div>
            {editCategory && updateCategoryAction ? (
              <div style={{ border: "1px solid var(--line)", padding: "20px", background: "#fffef8" }}>
                  ...
                  <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                    ...
                    <form
                      ...
                      onSubmit={(e) => {
                        if (
                          !confirm(
                            `Are you sure you want to delete category "${category.name}"? This operation cannot be undone.`
                          )
                        ) {
                          e.preventDefault();
                        }
