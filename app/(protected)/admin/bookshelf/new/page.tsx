    ...
    <main className="app-shell">
      <section className="app-card">
        ...
        <form action={createResource} className="stacked-form">
          ...
          <label>
            Resource Type *
            <select name="type" required style={{ width: "100%", padding: "13px 14px", border: "1px solid var(--line)", background: "#fffef8" }}>
          ...
          <label>
            Category *
            <select name="categoryId" required style={{ width: "100%", padding: "13px 14px", border: "1px solid var(--line)", background: "#fffef8" }}>
